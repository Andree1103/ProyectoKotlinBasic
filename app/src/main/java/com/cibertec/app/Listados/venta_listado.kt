...
import com.cibertec.app.Registros.RegisterVentaActivity
...
class venta_listado : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.floatingActionButton3.setOnClickListener{
            val intent = Intent(this, RegisterVentaActivity::class.java)
    ...
    override fun onStart(){
        ...
        GlobalScope.launch(Dispatchers.Main) {
            ...
            try {
                ...
                Toast.makeText(this@venta_listado,"No tienes acceso a Internet", Toast.LENGTH_LONG).show()
            }
            catch (ex:Exception){
                Toast.makeText(this@venta_listado,ex.message, Toast.LENGTH_LONG).show()
            }
            //
            finally {
    ...
    private fun VentaAdapter(): VentaAdapter {
        ventaAdapter = VentaAdapter(Detalle = { peli ->
            ...
            val intentar_ = Intent(this, RegisterVentaActivity::class.java).apply {
                putExtras(bundle_)
            }
