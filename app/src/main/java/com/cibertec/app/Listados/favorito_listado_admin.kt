...
import com.cibertec.app.databinding.ActivityFavoritoListadoAdminBinding
...
class favorito_listado_admin : AppCompatActivity()
{
    private lateinit var binding : ActivityFavoritoListadoAdminBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityFavoritoListadoAdminBinding.inflate(layoutInflater)
        setContentView(binding.root)


        binding.floatingActionButton2.setOnClickListener{
            val intent = Intent(this, RegisterEditFavoritoAdminActivity::class.java)
    ...
    override fun onStart(){
        ...
        GlobalScope.launch(Dispatchers.Main) {
            ...
            try {
                ...
                Toast.makeText(this@favorito_listado_admin,"No tienes acceso a Internet",Toast.LENGTH_LONG).show()
            }
            catch (ex:Exception){
                Toast.makeText(this@favorito_listado_admin,ex.message,Toast.LENGTH_LONG).show()
            }
            //
            finally {
    ...
    private fun FavoritoAdapter(): FavoritoAdapter {
        favoritoAdapter = FavoritoAdapter(Detalle = { peli ->
            ...
            val intentar_ = Intent(this, RegisterEditFavoritoAdminActivity::class.java).apply {
                putExtras(bundle_)
            }
