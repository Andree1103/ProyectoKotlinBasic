...
import com.cibertec.app.databinding.ActivityDulcesListadoClienteBinding
...
class dulces_listado_cliente : AppCompatActivity()
{
    private lateinit var binding : ActivityDulcesListadoClienteBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityDulcesListadoClienteBinding.inflate(layoutInflater)
    ...
    override fun onStart(){
        ...
        GlobalScope.launch(Dispatchers.Main) {
            ...
            try {
                ...
                Toast.makeText(this@dulces_listado_cliente,"No tienes acceso a Internet",Toast.LENGTH_LONG).show()
            }
            catch (ex:Exception){
                Toast.makeText(this@dulces_listado_cliente,ex.message,Toast.LENGTH_LONG).show()
            }
            //
            finally {
